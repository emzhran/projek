  ...
  <div class="card-body">
    ...
    <form action="<?= base_url('admin/members'); ?>" method="post">
      ...
      <div class="col-12 col-md-6 mb-3">
          ...
          <input type="texy" class="form-control <?php if ($validation->hasError('id_anggota')) : ?>is-invalid<?php endif ?>" id="id_anggota" name="id_anggota" value="<?= $oldInput['id_anggota'] ?? ''; ?>" placeholder="xxxxxxx" required>
          <div class="invalid-feedback">
