...
<div class="card">
  <div class="card-body">
    ...
    <form action="<?= base_url('admin/members/' . $member['uid']); ?>" method="post">
      ...
      <div class="col-12 col-md-6 mb-3">
          <label for="id_anggota" class="form-label">Member Id</label>
          <input type="text" class="form-control <?php if ($validation->hasError('id_anggota')) : ?>is-invalid<?php endif ?>" id="id_anggota" name="id_anggota" value="<?= $oldInput['id_anggota'] ?? $member['id_anggota'] ?? ''; ?>" placeholder="xxxxxx" required>
          <div class="invalid-feedback">
