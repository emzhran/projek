...
class MembersController extends ResourceController
{
    ...
    public function template_pdf($uid)
    {
        // Ambil data member berdasarkan UID
        $memberModel = new \App\Models\MemberModel();
        $member = $memberModel->find($uid);
        
        // Membuat instansi Dompdf
        $dompdf = new Dompdf();
        ...
        $html = view('members/pdf_template', ['member' => $member]);
        ...
        $filename = 'detail_member_' . $uid . '.pdf';
        $dompdf->stream($filename, [
            "Attachment" => 1 // Pastikan file di-download
        ]);
    }
    ...
    public function index()
    {
        ...
        if ($this->request->getGet('search')) {
            ...
            $members = $this->memberModel
                ...
                ->orLike('id_anggota', $keyword, insensitiveSearch: true)
    ...
    public function create()
    {
        if (!$this->validate([
            ...
            'id_anggota'     => 'required|string|max_length[50]',
